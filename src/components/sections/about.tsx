      ...
      <div className="max-w-7xl mx-auto content-padding">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed mb-8">SwissCareServices est votre partenaire de confiance pour des services de nettoyage professionnel en Suisse Romande. Nous nous engageons à utiliser des produits écologiques pour préserver votre environnement et votre santé.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            return <Card key={index} className="hover-lift shadow-subtle border-0 bg-card">
